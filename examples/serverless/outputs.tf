...
output "postgresql_rds_cluster_resource_id" {
  ...
  value       = module.aurora_postgresql.this_rds_cluster_resource_id
}
...
output "postgresql_rds_cluster_reader_endpoint" {
  ...
  value       = module.aurora_postgresql.this_rds_cluster_reader_endpoint
}
...
output "postgresql_rds_cluster_instance_endpoints" {
  ...
  value       = module.aurora_postgresql.this_rds_cluster_instance_endpoints
}

output "postgresql_rds_cluster_instance_ids" {
  description = "A list of all cluster instance ids"
  value       = module.aurora_postgresql.this_rds_cluster_instance_ids
}

# aws_security_group
output "postgresql_security_group_id" {
  description = "The security group ID of the cluster"
  value       = module.aurora_postgresql.this_security_group_id
}
...
output "mysql_rds_cluster_id" {
  description = "The ID of the cluster"
  value       = module.aurora_mysql.this_rds_cluster_id
}

output "mysql_rds_cluster_resource_id" {
  description = "The Resource ID of the cluster"
  value       = module.aurora_mysql.this_rds_cluster_resource_id
}
...
output "mysql_rds_cluster_reader_endpoint" {
  description = "The cluster reader endpoint"
  value       = module.aurora_mysql.this_rds_cluster_reader_endpoint
}
...
output "mysql_rds_cluster_master_password" {
  description = "The master password"
  value       = module.aurora_mysql.this_rds_cluster_master_password
  sensitive   = true
}
...
output "mysql_rds_cluster_instance_endpoints" {
  description = "A list of all cluster instance endpoints"
  value       = module.aurora_mysql.this_rds_cluster_instance_endpoints
}

output "mysql_rds_cluster_instance_ids" {
  description = "A list of all cluster instance ids"
  value       = module.aurora_mysql.this_rds_cluster_instance_ids
}

# aws_security_group
output "mysql_security_group_id" {
  description = "The security group ID of the cluster"
  value       = module.aurora_mysql.this_security_group_id
}
