...
| [time_static.password](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/static) | resource |
...
| <a name="input_master_password_secret_kms_key_id"></a> [master\_password\_secret\_kms\_key\_id](#input\_master\_password\_secret\_kms\_key\_id) | KMS key used to store the master secret | `string` | `null` | no |
| <a name="input_master_password_ssm_param_name"></a> [master\_password\_ssm\_param\_name](#input\_master\_password\_ssm\_param\_name) | Custom name used for the master password SSM param | `string` | `""` | no |
...
| <a name="input_store_master_password_to_ssm"></a> [store\_master\_password\_to\_ssm](#input\_store\_master\_password\_to\_ssm) | If using an auto-generated password, store it to SSM | `bool` | `true` | no |
...
| <a name="output_master_credentials_ssm_arn"></a> [master\_credentials\_ssm\_arn](#output\_master\_credentials\_ssm\_arn) | The SSM parameter where the master secret is stored |
