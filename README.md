...
| <a name="input_instances_use_cluster_name"></a> [instances\_use\_cluster\_name](#input\_instances\_use\_cluster\_name) | Determines whether cluster name is used instead of arn as the cluster identifier for instances | `bool` | `false` | no |
